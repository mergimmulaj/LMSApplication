<?php
include '../actions/contact-process.act.php';
?>
<!DOCTYPE html>
<html lang="en">
   <head>
         ...
         <div class="wrapper">
            <div class="content-left">
               ...
               <div class="content-body-contact">
                  <div class="container">  
                     <form  name ="contactForm" action="../actions/contact-process.act.php"  method="post">
                        <label for="fname">First Name</label>
                        <input type="text" class="text-input" id="fname" name="name" placeholder="Your name.." >
                        <p><?php if(isset($errors['firstname'])) echo $errors['firstname']; ?></p>
                        <label for="lname">Last Name</label>
                        <input type="text" class="text-input" id="l-name" name="lname" placeholder="Your last name.." >
                        ...
                        <input type="email" class="text-input" id="lname" name="email" placeholder="Your email.." >
                        ...
                        <p><?php if(isset($errors['country'])) echo $errors['country']; ?></p>
                         
                        <label for="subject">Subject</label>
                        <textarea id="subject" name="message" placeholder="Write something.." style="height:200px" ></textarea>
                        <p><?php if(isset($errors['message'])) echo $errors['message']; ?></p>
                        <input type="checkbox" name="checkbox" value="Accepted"> I accept!<br><br>
                        <input type="submit" class="input-submit" value="Submit" name="contact-submit">
                     </form>
                  </div>
               </div>
            </div>
