      ...
      <div id="header">
         <div class="wrapper">
            <div class="topbar">
               ...
               <h5 class="heading5-user"><i class="fas fa-user"></i></h5>
               <a href="../actions/logout-process.act.php"><button type="button" class="input-submit-green head-btn">Logout</button></a>
         ...
         <div class="wrapper">
            <div class="content-left">
               ...
               <div class="content-body-contact">
                  <div class="container">
                     <form name="addUserForm" onsubmit="return validateAddUserForm()" action="../actions/manage_users.act.php" method="post">
                        ...
                        <input type="text" class="text-input" id="lname" name="role" placeholder="Admin: 2 | User: 1" required>
